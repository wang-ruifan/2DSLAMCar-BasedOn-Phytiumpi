...
: ${AMENT_CURRENT_PREFIX:="/home/user/car_ws/install/car_gui"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/car_gui/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/car_gui/environment/path.sh"
